    ...
    c.fn.stick_in_parent = function(b) {
        ...
        K = function(a, b, q, C, F, u, r, G) {
            ...
            if (!a.data("sticky_kit")) {
                ...
                x();
                if (u !== C)
                    return D = void 0, d = p, z = E, l = function() {
                        var c,
                            l,
                            e,
                            k;
                        ...
                        B && (c = f.height(), u + p > c && !v && (d -= l, d = Math.max(c - u, d), d = Math.min(p, d), m && a.css({
                            ...
                            position: "fixed",
                            top: d
                        }, c.width = "border-box" === a.css("box-sizing") ? a.outerWidth() + "px" : a.width() + "px", a.css(c).addClass(t), null == n && (a.after(h), "left" !== r && "right" !== r || h.append(a)), a.trigger("sticky_kit:stick")), m && w && (null == k && (k = e + u + d > C + q), !v && k)))
                    ...
                    y = function() {
                        ...
                        g.position("position", "");
                        if (m)
                            return null == n && ("left" !== r && "right" !== r || a.insertAfter(h), h.remove()), a.removeClass(t)
